    ...
    return (
        <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
            ...
            <div>
                ...
                <input onChange={imageHandler} type="file" name='image' id="file-input" hidden className='bg-primary max-w-30 w-full py-3 px-4' />
            </div>
            <button onClick={() => AddProduct()} className='btn_pink_rounded mt-4 flexCenter gap-x-1'><MdAdd />Add Product</button>
        </div>
