        ...
        <table className='w-full mx-auto'>
          ...
          <tbody>
            {allproducts.map((product, i) => (
              <tr key={i} className='border-slate-900/20 text-gray-20 p-6 medium-14'>
                <td className='flexStart sm:flexCenter'>
                  <img src={product.image} alt="" height={43} width={43} className='rounded-lg-ring-1 rimg-slate-900/5 my-1' />
                </td>
