...
mongoose.connect("mongodb+srv://saraaramakrishnan:user123@cluster0.wzmksif.mongodb.net/Clothing-Website?retryWrites=true&w=majority&appName=Cluster0");
...
app.get('/popular', async (req, res) => {
    let products = await Product.find({});
    let newcollection = products.slice(2).slice(-4);
...
app.get('/categoryproducts', async (req, res) => {
    let products = await Product.find({});
    let categoryproducts = products.slice(0, 4);
